...
replace(b.营业收入,',',''))/replace(b.营业收入,',',''),4) as 营业收入增长率,
    round((replace(a.归属于上市公司股东的净利润,',','') - replace(b.归属于上市公司股东的净利润,',',''))/replace(b.归属于上市公司股东的净利润,',',''),4)
        as 归属于上市公司股东的净利润增长率,
    round((replace(a.归属于上市公司股东的扣除非经常性损益的净利润,',','') - replace(b.归属于上市公司股东的扣除非经常性损益的净利润,',',''))/replace(b.归属于上市公司股东的扣除非经常性损益的净利润,',',''),4)
        as 归属于上市公司股东的扣除非经常性损益的净利润增长率,
    round((replace(a.经营活动产生的现金流量净额,',','') - replace(b.经营活动产生的现金流量净额,',',''))/replace(b.经营活动产生的现金流量净额,',',''),4)
        as 经营活动产生的现金流量净额增长率,